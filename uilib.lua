...
function self:AddWindow(Options: table)
    ...
    if PreviousWindow == nil then
      ...
      WindowClone.Position = UDim2.new(WindowClone.Position.X.Scale + 0, WindowClone.Position.X.Offset, WindowClone.Position.Y.Scale, WindowClone.Position.Y.Offset)
    else
